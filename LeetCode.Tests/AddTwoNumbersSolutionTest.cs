...
namespace LeetCode.Tests
{
    ...
    public class AddTwoNumbersSolutionTest
    {
        ...
        [TestCase(new int[] { 2, 4, 3, 9 }, new int[] { 5, 6, 4, 1 }, ExpectedResult = new int[] { 7, 0, 8, 0, 1 })]
        ...
        [Test]
        [TestCase(new int[] { 1, 2 }, new int[] { 3 }, ExpectedResult = new int[] { 4, 2 })]
        [TestCase(new int[] { 1, 2, 3 }, new int[] { 0, 3 }, ExpectedResult = new int[] { 1, 5, 3 })]
